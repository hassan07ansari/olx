...
def contactus():
    if request.method == 'POST':
        ...
        # You can add more logic here, such as saving the data or sending an email
        return render_template('contactus.html', success=True)  # Render template with a success message or redirect
    else:
...
def predict():
    if request.method == "POST":
        ...
        return render_template("result.html",car_price = int(res[0]))
